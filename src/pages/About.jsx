...
import { Sparkles, Heart, Flower2, Scissors } from 'lucide-react';
    ...
    <div className="min-h-screen bg-creamy-vanilla font-quicksand overflow-hidden">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/hero.png" 
            className="w-full h-full object-cover opacity-30 scale-110 animate-spin-slow"
            alt="Hero background"
          />
          ...
          <div className="space-y-8 animate-in slide-in-from-bottom-8">
            ...
            <div className="flex gap-8">
              <div className="flex flex-col gap-2">
                <span className="text-4xl font-playfair font-bold text-sage-mist">100%</span>
                <span className="text-xs font-bold uppercase tracking-widest text-charcoal-berry/40">Handmade</span>
              </div>
              <div className="flex flex-col gap-2">
                <span className="text-4xl font-playfair font-bold text-blossom-pink">5k+</span>
                <span className="text-xs font-bold uppercase tracking-widest text-charcoal-berry/40">Stories Told</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { 
                ...
                desc: "Every bouquet is hand-assembled by our floral artists, ensuring no two are ever identical.",
                color: "text-pink-400"
              },
              { 
                icon: Heart, 
                title: "Memory Centric", 
                desc: "We design for the moment. Our charms are built to last as long as the memories they represent.",
                color: "text-red-400"
              },
              { 
                icon: Sparkles, 
                title: "Pure Magic", 
                desc: "From scent to texture, we focus on the sensory magic that makes a gift unforgettable.",
      ...
      <section className="max-w-4xl mx-auto px-6 py-32 text-center">
        <div className="relative inline-block mb-12">
          <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-xl mx-auto mb-6">
            <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80" alt="Founder" />
          </div>
        ...
        <blockquote className="text-3xl md:text-4xl font-playfair font-bold text-charcoal-berry italic leading-snug mb-10">
          "Beauty isn't a luxury; it's a necessity for the soul. At Bloom & Charm, we just help you find the knots that tie it all together."
        </blockquote>
        <p className="font-bold text-blossom-pink uppercase tracking-widest">— Maya Bloom, Founder</p>
      </section>
    </div>
  );
}
