...
import { Heart, ShoppingBag, ArrowLeft, Star, Truck, ShieldCheck, Sparkles, Plus, Minus, CheckCircle2, Loader2, Share2, Info } from 'lucide-react';
            ...
            <div className="relative group aspect-square rounded-[3rem] overflow-hidden bg-white shadow-2xl border border-pink-50">
              ...
              <div className="absolute top-6 right-6 flex flex-col gap-3">
                <button 
                  ...
                  className={`p-4 rounded-2xl shadow-xl transition-all hover:scale-110 active:scale-90 ${
              ...
              {product.cod && (
                <div className="absolute bottom-6 left-6 px-4 py-2 bg-white/80 backdrop-blur-md rounded-xl border border-pink-100 flex items-center gap-2 shadow-sm">
                  <CheckCircle2 size={16} className="text-green-500" />
                  <span className="text-xs font-bold text-charcoal-berry uppercase tracking-wider">COD Available</span>
                </div>
              )}
            </div>
          ...
          <div className="flex flex-col h-full">
            <div className="mb-8">
              ...
              <div className="flex items-baseline gap-4">
                <span className="text-4xl font-bold text-charcoal-berry">${product.price}</span>
                <span className="text-xl text-charcoal-berry/30 line-through">${(product.price * 1.2).toFixed(0)}</span>
            ...
            <div className="space-y-8 mb-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  disabled={adding}
                  className={`flex-1 flex items-center justify-center gap-3 py-5 rounded-3xl font-bold text-lg shadow-2xl transition-all active:scale-95 ${
                    adding 
            ...
            <div className="grid grid-cols-2 gap-4 pt-8 border-t border-pink-50">
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/50 border border-white">
                ...
                <div>
                  ...
                  <p className="text-xs text-charcoal-berry/40">On all orders above $50</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/50 border border-white">
              ...
              {similarProducts.map((p) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center mt-auto">
                    ...
                    <span className="font-bold text-charcoal-berry">${p.price}</span>
                  </div>
                </Link>
              ))}
            </div>
